          ...
          >
            ...
            <CardContent>
              <div className="text-xs space-y-0.5">
                ...
                <div className="truncate">Endpoint: {globalConfig?.defaultEndpoint || 'ide'} / {globalConfig?.serviceEndpointFamily || 'legacy'} | 压缩: {globalConfig?.compression.enabled ? '开' : '关'}</div>
